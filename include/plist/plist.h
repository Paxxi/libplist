...
#include <stdarg.h>
     ...
     */
    PLIST_EXTERN void plist_array_item_remove(plist_t node);
     ...
     */
    PLIST_EXTERN void plist_array_new_iter(plist_t node, plist_array_iter *iter);
     ...
     *          to iterate.
     */
    PLIST_EXTERN void plist_array_next_item(plist_t node, plist_array_iter iter, plist_t *item);
     ...
     */
    PLIST_EXTERN plist_t plist_dict_item_get_key(plist_t node);
     ...
     */
    PLIST_EXTERN const char* plist_get_string_ptr(plist_t node, uint64_t* length);
     ...
     */
    PLIST_EXTERN const char* plist_get_data_ptr(plist_t node, uint64_t* length);
     ...
     */
    PLIST_EXTERN void plist_to_xml_free(char *plist_xml);
     ...
     */
    PLIST_EXTERN void plist_to_bin_free(char *plist_bin);
